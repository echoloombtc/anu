...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/kenDevXD/anu/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/kenDevXD/anu/main/edu-op.py
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/usr/bin/python -O /usr/local/bin/edu-ovpn 8080
Restart=on-failure
